...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FileSample'
        db.create_table('sample_filesample', (
            ...
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('sample', ['FileSample'])

    def backwards(self, orm):
        # Deleting model 'FileSample'
        db.delete_table('sample_filesample')
