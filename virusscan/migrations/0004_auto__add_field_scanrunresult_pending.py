...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScanRunResult.pending'
        db.add_column(u'virusscan_scanrunresult', 'pending',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ScanRunResult.pending'
        db.delete_column(u'virusscan_scanrunresult', 'pending')
