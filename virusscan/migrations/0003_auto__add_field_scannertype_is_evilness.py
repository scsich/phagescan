...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScannerType.is_evilness'
        db.add_column(u'virusscan_scannertype', 'is_evilness',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ScannerType.is_evilness'
        db.delete_column(u'virusscan_scannertype', 'is_evilness')
