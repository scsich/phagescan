...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScannerType.active_workers'
        db.add_column(u'virusscan_scannertype', 'active_workers',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScannerType.active_workers'
        db.delete_column(u'virusscan_scannertype', 'active_workers')
