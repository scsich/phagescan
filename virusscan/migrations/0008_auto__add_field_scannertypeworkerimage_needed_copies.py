...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScannerTypeWorkerImage.needed_copies'
        db.add_column(u'virusscan_scannertypeworkerimage', 'needed_copies',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScannerTypeWorkerImage.needed_copies'
        db.delete_column(u'virusscan_scannertypeworkerimage', 'needed_copies')
    ...
    models = {
        ...
        u'virusscan.scannertype': {
            ...
            'active_workers': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'virusscan.scannertypeworkerimage': {
            ...
            'needed_copies': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'})
        },
        u'virusscan.scanrun': {
