...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScannerType.class_name'
        db.add_column(u'virusscan_scannertype', 'class_name',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=254),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScannerType.class_name'
        db.delete_column(u'virusscan_scannertype', 'class_name')
